...
@SequenceGenerator(name = "construtora", sequenceName = "SQ_CD_CONSTRUTORA", allocationSize = 1)
public class Construtora {
	
	@Id
	@Column(name = "CD_CONSTRUTORA")
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "construtora")
	private Long id;
